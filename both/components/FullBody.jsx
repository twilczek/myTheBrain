                        ...
                        <div className="box box-bordered box-color">
                            ...
                            <div className="box-content padding">
                                ...
                                <ul className="fa-ul loginList visible-md visible-lg">
                                    <li><i className="fa fa-li fa-check"></i><strong>Remember for life</strong>, not for
                                        exams
                                    </li>
                                    <li><i className="fa fa-li fa-check"></i>Learn smart and <strong>save your
                                        time</strong>
                                    </li>
                                    <li><i className="fa fa-li fa-check"></i><strong>Amaze</strong> everyone with
                                        <strong>robot-like
                                            memory</strong></li>
                                    <li><i className="fa fa-li fa-check"></i>Be a <strong>creator</strong>. TheBrain
                                        <strong>learns
                                            with you.</strong></li>
                                    <li><i className="fa fa-li fa-check"></i><strong>Make TheBrain Happy! :)</strong>
                                    </li>
                                </ul>
                    ...
                    <div className="col-md-6 loginSignUp">
                        <div className="box box-bordered box-color">
                            ...
                            <div className="box-content padding">
                                ...
                                <button type="submit" className="btn-mine quickButton btn-signUpWithFacebook"><i
                                    className="fa fa-hand-o-right"></i> Join
                                    <strong>TheBrain</strong>
                                    with <i className="fa fa-facebook-square"></i>acebook!
                                </button>
                                ...
                                <p className="lead">Not familiar? Enjoy the
                                    <strong>introductory video</strong> first. </p>
                            </div>
                        </div>
                    </div>
                </div>
